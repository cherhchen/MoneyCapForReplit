...
def buttonClicked(date_entry, category_entry, item_entry, expense_entry):
    ...
    if expense_entry.strip() != '' and expense_entry.isdecimal() == True:
        ...
        var = StringVar()
        stats_label = Label(stats_frame, relief=RAISED, textvariable=var, bg='#bfe9f5', font=('Courier', 7))
        ...
        totalvar = StringVar()
        total_label = Label(stats_frame, relief=RAISED, textvariable=totalvar, bg='#bfe9f5', font=('Courier', 7 ,'bold'))
...
advice_button.place(relx=0.85, rely=0.05, relwidth=0.05, relheight=0.05)
about_moneycap = Text(advice_frame, background= 'gray', highlightthickness= 0)
...
moreinfo_button.place(relx=0.9, rely=0.05, relwidth=0.08, relheight=0.05)
...
about_text = tk.Label(aboutFrame2, text="It’s easy to spend money, but when it comes to saving, budgeting, and planning—well...that other part can be a little complicated.\n Introducing Money Cap: \n A tool to organize monetary expenses and learn how to budget. \n This app allows you to input your purchases, organize your items into categories, and allocate your savings. With a simple and systematic layout and personalized financial advice, Money Cap is an effective tool to advance your financial literacy skills.", font=('Arial', 7), wraplength=840, justify=CENTER, bg='white')
about_label.pack()
about_text.pack()
...
imgFrame = tk.Frame(moreinfo_frame, bd=10, bg='white')
